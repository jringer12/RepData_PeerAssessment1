...
```
The mean number of steps per day for the original data is `r results[1]`.  
The median number of steps per day for the original data is `r results[2]`.
...
The maximum total steps is `r max.step` and occurs at interval `r interval`.
...
The mean number of steps per day for the imputed data is `r imp.results[1]`.  
The median number of steps per day for the imputed data is `r imp.results[2]`.
